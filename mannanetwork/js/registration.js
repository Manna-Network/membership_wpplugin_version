...
document.getElementById("summary").value = myarr[1];
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsummaryreport.php?q="+myarr[1],true);
  xmlhttp.send();
...
document.getElementById("regional_name").value = myarr[2];
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubloc1.php?regional_num="+myarr[1],true);
  xmlhttp.send();
}
...
document.getElementById("regional_num").value = myarr[1];
document.getElementById("regional_name").value = myarr[2];
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubloc2.php?regional_num="+myarr[1],true);
  xmlhttp.send();
}
...
document.getElementById("regional_name").value = myarr[2];
  ...
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubloc3.php?regional_num="+myarr[1],true);
  xmlhttp.send();
}
...
//function showSubCat1(str, path) {
function showSubCat1(str) {
var myarr = str.split(":");
window.alert("showSubCat1   myarr[1] = " +  myarr[1]);
//window.alert("showSubCat1   path = " +  path);
...
document.getElementById("category_name").value = myarr[2];
  ...
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubcat1.php?q="+myarr[1],true);
  xmlhttp.send();
}
...
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubcat2.php?q="+myarr[1],true);
  xmlhttp.send();
  }else{
...
document.getElementById("category_id").value = myarr[1];
  ...
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubcat3.php?q="+myarr[1],true);
  xmlhttp.send();
  }else{
...
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
  xmlhttp.open("GET","/wp-content/plugins/mannanetwork/getsubcat4.php?q="+myarr[1],true);
  xmlhttp.send();
  }else{
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
